(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("cooparser", ["axios"], factory);
	else if(typeof exports === 'object')
		exports["cooparser"] = factory(require("axios"));
	else
		root["cooparser"] = factory(root["axios"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_axios__) {
...
var Cooparser = /** @class */ (function () {
    ...
    Cooparser.prototype.parse = function (url) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, this.returnHTML(url)];
                    case 1:
                        html = _e.sent();
                        $ = cheerio.load(html);
                        ...
                        thumbnail = (_c = $("meta[property='og:image']").attr('content')) !== null && _c !== void 0 ? _c : '';
                        provider = (_d = $("meta[property='og:site_name']").attr('content')) !== null && _d !== void 0 ? _d : '-';
                        favicon = this.findFavicon(html, url);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log('[GET HTML] ERROR: ', error_1);
                        return [3 /*break*/, 3];
    ...
    Cooparser.prototype.findFavicon = function (html, url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                location = html.indexOf("<link rel=\"shortcut icon");
                if (location == -1) {
                    location = html.indexOf("<link rel=\"apple-touch-icon");
                }
                if (location != -1) {
                    start = html.indexOf("href=", location);
                    if (start != -1) {
                        end = html.indexOf("\"", start + 6);
                        favicon_url = html.substring(start + 6, end);
...
//# sourceMappingURL=cooparser.map